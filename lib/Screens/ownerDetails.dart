    ...
    return Scaffold(
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            children: [
              CustomWhiteAppBar(headerText: 'Owner Details',),
              SizedBox(height: 15.0,),
              Container(
                padding: EdgeInsets.only(left: 25.0,right: 10.0,top: 15.0,bottom: 15.0),
                height: 90.0,
                ...
                child: Row(
                  children:[
                  ImagePlaceHolder(imagePath: 'images/google.png',),
                    SizedBox(width: 15.0,),
                    Column(
...
class _OwnerDataTableState extends State<OwnerDataTable> with SingleTickerProviderStateMixin{
 List<Tab> tabs = [
   Tab(text: " Forms ",),
   Tab(text: " Entries ",),
   Tab(text: " Horses ",),
...
class OwnerFormDataTable extends StatefulWidget {
  const OwnerFormDataTable({Key? key}) : super(key: key);
